...
class SwsSettings {
    ...
    constructor() {
        ...
        // Enables default URL Normalization without requiring a swagger.json. 
        // if a swagger.json is provided or swaggerOnly is enabled, this setting will be ignored
        // Also does not generate metrics for 404 links, only a 404 counter (api_all_404_requests_total) to prevent metrics bloat
        // also works with
        //  normalizationMasks - a regular expression can be provided to override the default URL Normalization
        this.enablePathNormalization = false;

        // array of regular expressions that can be used with enablePathNormalization to replace values in the path
        this.normalizationMasks = [];

        // List of urls to filter from metrics collection by default, IE: healthchecks, etc...
        this.filteredUrls = [];
