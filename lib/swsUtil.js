...
module.exports.supportedOptions = {
    ...
    // Also does not generate metrics for 404 links, only a 404 counter to prevent metrics bloat
    // also works with
    //  normalizationPattern - a regular expression can be provided to override the default URL Normalization
    enablePathNormalization     : "enablePathNormalization"

};

// Return response status code class
module.exports.getStatusCodeClass = function (code) {
    if (enablePathNormalization && code == 404) return "404";
